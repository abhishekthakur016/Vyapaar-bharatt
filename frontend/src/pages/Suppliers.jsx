...
function Suppliers() {
  ...
  useEffect(() => {
    const fetchSuppliers = async () => {
      try {
        ...
        setError(error.message || "Unable to load suppliers.");
      } finally {
        setLoading(false);
      }
    };
  ...
  const industries = useMemo(() => {
    ...
    return ["All Industries", ...new Set(values)];
  }, [suppliers]);
  ...
  const filteredSuppliers = useMemo(() => {
    ...
    return suppliers.filter((supplier) => {
      ...
      const matchesIndustry =
        industry === "All Industries" || supplier.industry === industry;
  ...
  }, [suppliers, search, industry, location, verifiedOnly]);
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl font-bold leading-tight text-[#0b1f3a] md:text-5xl">
              ...
              <span className="block text-[#0952d4]">Across India</span>
            </h1>

            <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
              Discover manufacturers, suppliers, wholesalers and service
              providers for your business requirements.
            </p>
          </div>
          ...
          <div className="mt-8 max-w-4xl">
            <div className="flex flex-col gap-3 rounded-2xl border border-slate-200 bg-white p-3 shadow-lg shadow-slate-200/50 md:flex-row">
              ...
              <button
                type="button"
                onClick={() => {
                  document.getElementById("supplier-filters")?.scrollIntoView({
                    behavior: "smooth",
                  });
                }}
        ...
        <div className="grid gap-8 lg:grid-cols-[260px_1fr]">
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <SlidersHorizontal size={18} className="text-[#0952d4]" />
          ...
          <div>
            ...
            <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <h2 className="text-2xl font-bold text-[#0b1f3a]">Suppliers</h2>
            ...
            {filteredSuppliers.length === 0 ? (
              <div className="rounded-2xl border border-slate-200 bg-white p-10 text-center shadow-sm">
                ...
                <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">
                  Try changing your search or removing some filters to find more
                  suppliers.
                </p>
