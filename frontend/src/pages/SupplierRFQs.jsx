  ...
  useEffect(() => {
    const fetchRequirements = async () => {
      try {
        ...
        setError(err.message || "Unable to load RFQ requests.");
      } finally {
        setLoading(false);
      }
    };
    ...
    try {
      ...
      const response = await fetch("/api/quotes", {
        ...
        body: JSON.stringify({
          ...
          quotedPrice: Number(quoteData.quotedPrice),
          quantity: Number(quoteData.quantity),
          unit: quoteData.unit || selectedRFQ.unit || "Piece",
      ...
      setSuccess("Your quote has been submitted successfully.");
      ...
      setSubmitError(
        err.message || "Unable to submit quote. Please try again.",
      );
    } finally {
      setSubmitting(false);
    }
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 text-sm leading-6 text-blue-100 sm:text-base">
              Discover buyer requirements and send competitive quotations
              directly.
            </p>
          </div>
        </div>
          ...
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-3xl bg-white shadow-2xl">
            ...
            <div className="p-5 sm:p-6">
              ...
              <div className="rounded-2xl bg-slate-50 p-5">
                <h3 className="font-bold text-[#0b1f3a]">Buyer Requirement</h3>
                ...
                <div className="mt-5 grid gap-3 sm:grid-cols-2">
                  ...
                  <div>
                    <p className="text-xs text-slate-400">Delivery Location</p>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm font-bold text-slate-700">
                      {formatDate(selectedRFQ.required_by)}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm font-bold text-slate-700">
                      {selectedRFQ.max_budget
                        ? `₹${Number(selectedRFQ.max_budget).toLocaleString(
                            "en-IN",
                          )}`
                        : "Not specified"}
                    </p>
              ...
              {!showQuoteForm ? (
                ...
                <form onSubmit={handleQuoteSubmit} className="mt-5 space-y-5">
