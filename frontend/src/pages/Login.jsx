...
import { ShoppingCart, Factory, ArrowRight, X } from "lucide-react";
import { GoogleLogin } from "@react-oauth/google";

function Login({ isModal = false, onSuccess, onClose }) {
  ...
  const content = (
    <div
      className={
        isModal
          ? "relative w-full max-w-md rounded-3xl border border-slate-200 bg-white p-8 shadow-2xl"
